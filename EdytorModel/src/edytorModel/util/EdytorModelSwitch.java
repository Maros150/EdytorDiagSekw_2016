 ...
 * @generated
 */
public class EdytorModelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EdytorModelPackage.OPERATION: {
				Operation operation = (Operation)theEObject;
				T result = caseOperation(operation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EdytorModelPackage.LOOP: {
			...
			case EdytorModelPackage.CODE: {
				Code code = (Code)theEObject;
				T result = caseCode(code);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EdytorModelPackage.ELSE_IF: {
				ElseIf elseIf = (ElseIf)theEObject;
				T result = caseElseIf(elseIf);
				if (result == null) result = caseOperation(elseIf);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EdytorModelPackage.OPERATIONS_QUEUE_ELEMENT: {
				OperationsQueueElement operationsQueueElement = (OperationsQueueElement)theEObject;
				T result = caseOperationsQueueElement(operationsQueueElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EdytorModelPackage.ELSEI_FQUEUE_ELEMENT: {
				ElseiFQueueElement elseiFQueueElement = (ElseiFQueueElement)theEObject;
				T result = caseElseiFQueueElement(elseiFQueueElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EdytorModelPackage.ELSE: {
				Else else_ = (Else)theEObject;
				T result = caseElse(else_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EdytorModelPackage.CODE_BLOCK: {
				CodeBlock codeBlock = (CodeBlock)theEObject;
				T result = caseCodeBlock(codeBlock);
				if (result == null) result = caseOperation(codeBlock);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EdytorModelPackage.FUNCTION_BLOCK: {
				FunctionBlock functionBlock = (FunctionBlock)theEObject;
				T result = caseFunctionBlock(functionBlock);
				if (result == null) result = caseOperation(functionBlock);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EdytorModelPackage.ARGUMENT: {
				Argument argument = (Argument)theEObject;
				T result = caseArgument(argument);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EdytorModelPackage.FUNCTION_DEFINITION: {
				FunctionDefinition functionDefinition = (FunctionDefinition)theEObject;
				T result = caseFunctionDefinition(functionDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EdytorModelPackage.CLASS: {
				edytorModel.Class class_ = (edytorModel.Class)theEObject;
				T result = caseClass(class_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EdytorModelPackage.ACTOR: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Operations Queue Element</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Operations Queue Element</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOperationsQueueElement(OperationsQueueElement object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Elsei FQueue Element</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Elsei FQueue Element</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseElseiFQueueElement(ElseiFQueueElement object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseClass(edytorModel.Class object) {
		return null;
	}
