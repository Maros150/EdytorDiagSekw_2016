 ...
 * </p>
 * <ul>
 *   <li>{@link edytorModel.impl.ActorImpl#getOperationsqueue <em>Operationsqueue</em>}</li>
 *   <li>{@link edytorModel.impl.ActorImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActorImpl extends MinimalEObjectImpl.Container implements Actor {
	...
	protected EClass eStaticClass() {
		return EdytorModelPackage.Literals.ACTOR;
	}
	...
	public EList<OperationsQueueElement> getOperationsqueue() {
		if (operationsqueue == null) {
			operationsqueue = new EObjectContainmentEList<OperationsQueueElement>(OperationsQueueElement.class, this, EdytorModelPackage.ACTOR__OPERATIONSQUEUE);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdytorModelPackage.ACTOR__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EdytorModelPackage.ACTOR__OPERATIONSQUEUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EdytorModelPackage.ACTOR__NAME:
				return getName();
		}
